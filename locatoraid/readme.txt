...
= 3.9.61 =
BUG: When editing a location's coordinates by moving the map icon the same value was being filled for both coordinates.

= 3.9.60 =
Added the "skipgeo" attribute for the shortcode to discard search results from geocoding if there are any database string matches.
